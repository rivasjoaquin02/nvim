...
vim.keymap.set("n", "<F2>", dap.terminate, silent)
vim.keymap.set("n", "<F5>", dap.continue, silent)
--vim.keymap.set("n","<F10>", dap.step_over, silent)
vim.keymap.set("n", "<F10>", dap.step_into, silent)
vim.keymap.set("n", "<F12>", dap.step_out, silent)

vim.keymap.set("n", "<leader>du", dapui.toggle, silent)
...
vim.keymap.set("n", "<leader>ddd", dap.clear_breakpoints, silent)
vim.keymap.set("n", "<leader>dk", dap.toggle_breakpoint, silent)
